...
Las justas y los torneos,\footA[ad=189]{}{\hskip-4pt\textbf{/190--192}\enskip\emph{transp.} {\rl}}\\
...
%
\begin{center}
	\textbf{XXV}\footT{\textbf{XXV} XIII en {\jm}. \textbf{\char"02016} dirige la fabla al maestre do\emph{n} rodrigo su padre {\eg}; ffabla del maestre do\emph{n} rr\emph{odri}go ma\emph{n}riq\emph{ue} {\hh}.}
\end{center}
\postart
...
%
\begin{center}
	\textbf{XXVII}\footT{\textbf{XXVII} XV en {\jm}. \textbf{\char"02016} conpara {\eg}.}
\end{center}
\postart
...
%
\begin{center}
	\textbf{XXVIII}\footT{\textbf{[XXVIII]} XXVI en {\jm}. \textbf{\char"02016} prosigue {\eg}.}
\end{center}
\postart
...
%
\begin{center}
	\textbf{XXXIV}\footT{\textbf{XXXIV} XXII en {\jm}. \textbf{\char"02016} ffabla la muerte con el maestre {\eg}.}
\end{center}
\postart
...
\repage
%
Tras la copla XL, en {\im} yace un epitafio con el encabezamiento \comillas{En su sepultura dize desta manera}, que enuncia:\vskip5pt\par
%
\bnum
\postart
